...
$GESTION_SN 					= 0; 								// Gestion des numéros de série
$GESTION_CONSTRUCTEUR	= 0;								// Gestion de la référence du constructeur et de la référence OEM
$GESTION_REF_INTERNE	= 0;								// Gestion de la référence interne
...
$ARTICLE_QTE_NB_DEC = 2;									// Nombre de décimale pour la quantité d'un article
...
$DEFAUT_ARTICLE_LT 		= 730*24*3600;		// Durée de vie d'un article, par défaut
...
$ARTICLE_IMAGE_MINIATURE_RATIO = 150; //ratio de réduction des images d'articles pour la miniature
...
$PIED_DE_PAGE_DROIT_1 = "Tél : 03 66 72 13 52 - Fax : 09 72 15 48 67";
