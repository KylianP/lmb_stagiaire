...
<a href="#" class="ajout"  id="link_add_new_user" <?php 
									...
									//permission (8) Gestion des Administrateurs
									if (!$_SESSION['user']->check_permission ("8") && isset($profils[$ADMIN_ID_PROFIL])) { echo 'style="display:none"'; }?>>Ajouter un nouvel utilisateur</a>
<script type="text/javascript">
...
// <![CDATA[
	...
	Event.stop(evt);
	page.verify("compta_compte_bancaire_contact","index.php#compta_compte_bancaire_contact.php?ref_contact=<?php echo $contact->getRef_contact();?>", "true", "_blank");
	});
// ]]>
</script>
...
// <![CDATA[
	...
	Event.stop(evt);
	page.verify("compta_extrait_compte_contact","index.php#compta_extrait_compte_contact.php?ref_contact=<?php echo $contact->getRef_contact();?>", "true", "_blank");
	});
// ]]>
</script>
...
// <![CDATA[
	...
	Event.stop(evt);
	page.verify("compta_synth_creances_contact","index.php#compta_synth_creances_contact.php?ref_contact=<?php echo $contact->getRef_contact();?>", "true", "_blank");
	});
// ]]>
</script>
