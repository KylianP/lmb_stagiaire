			...
			<tr>
				...
				?>
				 <table style="width:100%" cellpadding="0" cellspacing="0">
					...
					<?php 
						if (!$liste_reglement_valide) {?>
							<tr>
								<td colspan="3" style="text-align:center">
								<span style="font-size:9px; font-style:italic;">Aucun r&egrave;glement enregistr&eacute;.</span>								</td>
							</tr>
							<?php
						}  else {?>
							<tr>
							...
							for ($i=0; $i<3 ;$i++) {
								...
								?>
								<tr class="<?php if ($liste_reglement_valide[$i]->valide) {echo "reglement_line_valide";} else {echo "reglement_line_unvalide";}?>">
