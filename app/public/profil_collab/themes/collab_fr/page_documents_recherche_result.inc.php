...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="">
	...
	<tr>
		<td style="width:325px;">
			<a href="#" id="all_coche_s" class="doc_link_simple">Tout cocher</a> / <a href="#" id="all_decoche_s" class="doc_link_simple">Tout d&eacute;cocher</a> / <a href="#" id="all_inv_coche_s" class="doc_link_simple">Inverser la s&eacute;lection</a> 
		</td>
		<td style="" >
...
Event.observe("all_coche_s", "click", function(evt){
	Event.stop(evt); 
	coche_line_search_docs ("coche", "_s", <?php echo $indentation;?>);
});
Event.observe("all_decoche_s", "click", function(evt){
	Event.stop(evt); 
	coche_line_search_docs ("decoche", "_s", <?php echo $indentation;?>);
});
Event.observe("all_inv_coche_s", "click", function(evt){
	Event.stop(evt); 
	coche_line_search_docs ("inv_coche", "_s", <?php echo $indentation;?>);
});
	
Event.observe("coche_action_s", "change", function(evt){
if ($("coche_action_s").value != "") {
action_recherche($("coche_action_s").value, "_s" , <?php echo $indentation;?>);
}
});		
</script>
...
<script type="text/javascript">
Event.observe("order_ref_doc", "click",  function(evt){Event.stop(evt); $('orderby_s').value='ref_doc'; $('orderorder_s').value='<?php if ($form['orderorder']=="ASC" && $form['orderby']=="ref_doc") {echo "DESC";} else {echo "ASC";}?>'; page.documents_recherche_simple();}, false);
Event.observe("order_type_doc", "click",  function(evt){Event.stop(evt); $('orderby_s').value='lib_type_doc'; $('orderorder_s').value='<?php if ($form['orderorder']=="ASC" && $form['orderby']=="lib_type_doc") {echo "DESC";} else {echo "ASC";}?>'; page.documents_recherche_simple();}, false);
Event.observe("order_etat_doc", "click",  function(evt){Event.stop(evt); $('orderby_s').value='lib_etat_doc'; $('orderorder_s').value='<?php if ($form['orderorder']=="ASC" && $form['orderby']=="lib_etat_doc") {echo "DESC";} else {echo "ASC";}?>'; page.documents_recherche_simple();}, false);
Event.observe("order_contact_doc", "click",  function(evt){Event.stop(evt); $('orderby_s').value='nom_contact'; $('orderorder_s').value='<?php if ($form['orderorder']=="ASC" && $form['orderby']=="nom_contact") {echo "DESC";} else {echo "ASC";}?>'; page.documents_recherche_simple();}, false);
Event.observe("order_montant_doc", "click",  function(evt){Event.stop(evt); $('orderby_s').value='montant_ttc'; $('orderorder_s').value='<?php if ($form['orderorder']=="ASC" && $form['orderby']=="montant_ttc") {echo "DESC";} else {echo "ASC";}?>'; page.documents_recherche_simple();}, false);
Event.observe("order_date_doc", "click",  function(evt){Event.stop(evt); $('orderby_s').value='date_doc'; $('orderorder_s').value='<?php if ($form['orderorder']=="ASC" && $form['orderby']=="date_doc") {echo "DESC";} else {echo "ASC";}?>'; page.documents_recherche_simple();}, false);
