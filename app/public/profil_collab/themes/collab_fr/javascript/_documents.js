function delier_doc_reglement (ref_doc, ref_reglement) {
	var AppelAjax = new Ajax.Request( 
									...
									{
									parameters: {ref_doc: ref_doc, ref_reglement : ref_reglement},
									evalScripts:true, 
...
var AppelAjax = new Ajax.Updater(
			...
			{
				parameters: {ref_article: id_article, ref_doc_line: id_doc_line, cible: target},
				evalScripts:true,
				onLoading:S_loading,
				onSuccess:H_loading
			}
...
function maj_line_nl (ref_doc_line, nl, new_nl, old_qte_nl, new_qte_nl, art_nl, qte_nl, indentation_art, indentation_nl) {
	...
	var AppelAjax = new Ajax.Request(
									...
									{
									parameters: {ref_doc: ref_doc, ref_doc_line: ref_doc_line, nl: nl, new_nl: new_nl, old_qte_nl: old_qte_nl, new_qte_nl: new_qte_nl, art_nl: art_nl, qte_nl: qte_nl, indentation_art: indentation_art, indentation_nl: indentation_nl},
									evalScripts:true,
									onLoading:S_loading, onException: function () {S_failure();},
									onSuccess: function (requester){
										requester.responseText.evalScripts();
...
function generer_code_affaire (id_info_content) {
	var AppelAjax = new Ajax.Request(
									...
									{
									parameters: {code_affaire: escape($F(id_info_content))}, 
									evalScripts: true, 
									onLoading:S_loading, onException: function(){ S_failure();}, 
									onComplete: function(requester){
...
function generer_new_open_doc (global_option) {
	...
	var AppelAjax = new Ajax.Updater(
															 ...
															 {
															 parameters: {ref_doc: ref_doc, global_option: global_option },
															 evalScripts:true,
															 onLoading:S_loading
															 }
															 );
...
function charger_contenu_reglements(bool) {
	...
	var AppelAjax = new Ajax.Updater(
															...
															{
															parameters: {ref_doc: ref_doc, reload: bool},
															evalScripts:true,
															onLoading:S_loading, onException: function () {S_failure();},
															onComplete: function() {
																						H_loading();
