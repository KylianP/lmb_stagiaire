...
<div  id="corps_tb">
	...
	<table width="950px" height="350px" border="0" align="right" cellpadding="0" cellspacing="0" >
		<tr>
			...
			<ul>
			<li><a href="#" class="menu_tb_select" id="select_menu_tbv1" style="border-right:1px  solid #000000">Tableau de Bord des Ventes</a></li>
			...
			<li><a href="#" class="menu_tb_unselect" id="select_menu_tbv4" style="border-right:1px  solid #000000">Historique des Ventes</a></li>
