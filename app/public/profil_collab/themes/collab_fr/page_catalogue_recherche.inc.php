...
<div class="emarge">
<p class="titre">Recherche d'un article </p>
...
<form action="#" method="GET" id="form_recherche_s" name="form_recherche_s">
	...
	?>"   class="classinput_xsize"/>
		...
		<tr>
			<td>&nbsp;</td>
			<td><span class="labelled_text" <?php if(!$GESTION_CONSTRUCTEUR || !$_SESSION['user']-> check_permission("22",$CONSTRUCTEUR_ID_PROFIL)){?>style="display:none"<?php } ?>>Constructeur:</span></td>
			<td>
				<select name="ref_constructeur_s" id="ref_constructeur_s" class="classinput_xsize" style="width:100%; <?php if(!$GESTION_CONSTRUCTEUR || !$_SESSION['user']-> check_permission("22",$CONSTRUCTEUR_ID_PROFIL)){?> display:none;<?php } ?>"><option value=''>Tous</option></select>
			</td>
			<td style="padding-left:35px">
...
<form action="#" method="GET" id="form_recherche_a" name="form_recherche_a">
	<table style="width:97%">
		...
		<tr>
			...
			<td><span class="labelled_text" <?php if(!$GESTION_CONSTRUCTEUR || !$_SESSION['user']-> check_permission("22",$CONSTRUCTEUR_ID_PROFIL)){?>style="display:none"<?php } ?>>Constructeur:</span></td>
			<td>
				<select name="ref_constructeur" id="ref_constructeur" class="classinput_xsize" style="width:100%;  <?php if(!$GESTION_CONSTRUCTEUR || !$_SESSION['user']-> check_permission("22",$CONSTRUCTEUR_ID_PROFIL)){?> display:none;<?php } ?>"><option value=''>Tous</option></select>			</td>
			<td style="padding-left:35px">
...
//lance la recherche
Event.observe('form_recherche_s', "submit", function(evt){page.catalogue_recherche_simple();  
	Event.stop(evt);});
Event.observe('form_recherche_a', "submit", function(evt){page.catalogue_recherche_avancee();  
	Event.stop(evt);});
