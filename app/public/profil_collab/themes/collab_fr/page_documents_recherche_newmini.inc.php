	...
	<tr>
		...
		<td>
			...
			if ($type_liste->id_type_doc == 10) {continue;}
				if ( $type_liste->id_type_doc == 1) {
				?><optgroup label="Documents clients"></optgroup><?php
				}
				if ( $type_liste->id_type_doc == 5) {
				?><optgroup label="Documents fournisseurs"></optgroup><?php
				}
				if ( $type_liste->id_type_doc == 9) {
				?><optgroup label="Documents stock"></optgroup><?php
				}
				?>
