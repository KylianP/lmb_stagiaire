...
<div style="padding-left:10px; padding-right:10px">
	...
	<span id="compta_livraisons_client_nonfacturees" class="grey_caisse" ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_bleue.gif"  style="padding-right:10px; float:left" vspace="3" /> Livraisons non facturées</span><br /><br />
	
	<span id="compta_factures_client_nonreglees" class="grey_caisse" ><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_bleue.gif"  style="padding-right:10px; float:left" vspace="3" /> Factures non réglées</span><br /><br />
