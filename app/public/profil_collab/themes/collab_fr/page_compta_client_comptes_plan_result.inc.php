	...
	?>
		<tr id="line_compte_comptable" style="">
			...
			Event.observe('numero_compte_compta_client_<?php echo $fiche->ref_contact;?>', 'click',  function(evt){
				...
				charger_compta_plan_mini_moteur ("compte_plan_comptable_search.php?retour_value_id=numero_compte_compta_client_<?php echo $fiche->ref_contact;?>&retour_lib_id=aff_numero_compte_compta_client_<?php echo $fiche->ref_contact;?>&indent=numero_compte_compta_client_<?php echo $fiche->ref_contact;?>&ref_contact=<?php echo $fiche->ref_contact;?>&num_compte=<?php if($fiche->categ_defaut_numero_compte) { echo $fiche->categ_defaut_numero_compte;} else { echo $DEFAUT_COMPTE_TIERS_VENTE;}?>");
				Event.stop(evt);
			},false); 
