		...
		<td>
			...
			<table class="infotable" id="start_visible_<?php echo $caiu?>">
				...
				<tr>
					...
					<?php if ($site_web->getLib_site_web()!="") {?>
					<a href="#" id="link_show_site_lib<?php echo $caiu?>" class="modif_input2"><strong><?php echo  htmlentities($site_web->getLib_site_web())?></strong></a>
					<script type="text/javascript">
				...
				<tr>
					...
					<td>
					<a href="<?php if (!preg_match("#^((http|https|ftp)://)#", $site_web->getUrl())) {echo "http://";} ?><?php echo  $site_web->getUrl()?>" target="_blank" ><?php echo  htmlentities(substr(preg_replace("#(http://|https://|ftp://)(([[:punct:]]|[[:alnum:]])*)#",
											"\\2", $site_web->getUrl()),0,20))?>...</a>
					</td>
				</tr>
				<?php } ?>
