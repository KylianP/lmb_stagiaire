...
<!--	<input type="image" src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/bt-imprimer.gif"  onclick="javascript:window.print()"/>-->
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<br />
			<span id="imprimer_details_comm" style="cursor:pointer; text-decoration:underline">Imprimer les détails</span>
			<SCRIPT type="text/javascript">
			...
			Event.observe("imprimer_details_comm", "click", function(evt){
				Event.stop(evt);
				window.open ("compta_situation_commerciaux_result.php?recherche=1&print=2&page_to_show_s="+$("page_to_show_s").value+"&date_fin="+$("date_fin").value+"&date_debut="+$("date_debut").value+"&date_exercice="+$("date_exercice").value, "_blank");
			}, false);
			</SCRIPT>
			</td>
		</tr>
