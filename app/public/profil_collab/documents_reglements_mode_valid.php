...
if (isset($_REQUEST["id_reglement_mode"])) {
	...
	if (isset($_REQUEST["doc_ACCEPT_REGMT"])) { $infos["doc_ACCEPT_REGMT"] = $_REQUEST["doc_ACCEPT_REGMT"];}
...
include ($DIR.$_SESSION['theme']->getDir_theme()."page_documents_reglements_mode_valid.inc.php");
