...
document.write ('<a href="http://www.lundimatin.fr" target="_blank" class="grey_text">Lundi Matin Business</a> est un logiciel libre de gestion d\'entreprise, distribué sous licence <a href="http://www.lundimatin.fr/site/licence_opensource_lmpl.php" target="_blank" class="grey_text">LMPL</a>');
document.write ('</div></td></tr>');
