...
public function open_doc ($select = "", $left_join = "") {
	...
	$select = ", db.id_stock, s.lib_stock, s.ref_adr_stock, db.id_livraison_mode, db.ref_doc_externe, ac.factures_par_mois, ac.encours, db.id_magasin ";
		...
		case 11: case 12: case 13: 
			if ($this->id_etat_doc == 14 || $this->id_etat_doc == 15) {
				...
				foreach ($this->contenu_materiel as $doc_line) {
					edi_event(115,$doc_line->ref_article); 
				}
			}
		break;
		case 14: case 15:
