...
final public function ajouter_adresse ($infos_adresse) {
	...
	$adresse = new adresse ();
	return $adresse->create($this->ref_contact, $lib_adresse, $text_adresse,  $code_postal, $ville, $id_pays, $note, $ref_adresse);
}
...
final public function ajouter_coordonnee ($infos_coordonnee) {
	...
	return $coordonnee->create($this->ref_contact, $lib_coord, $tel1, $tel2, $fax,  $email, $note, $ref_coord_parent, $email_user_creation, $ref_coord);
}
...
final public function ajouter_site ($infos_site) {
	...
	$site = new site ();
	return $site->create($this->ref_contact, $lib_site_web, $url, $login, $pass, $note, $ref_site);
}
