...
N'hésitez pas à nous faire part de vos expériences sur notre forum <span id="open_forum_lmb" style="cursor:pointer; text-decoration:underline">http://www.lundimatin.fr/site/forum/index.php</span>


			<SCRIPT type="text/javascript">
			Event.observe("open_forum_lmb", "click", function(evt){
				window.open ("http://www.lundimatin.fr/site/forum/index.php", "_blank");
			}, false);
