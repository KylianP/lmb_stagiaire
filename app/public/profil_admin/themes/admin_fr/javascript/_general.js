...
appelpage.prototype = {
	...
	annuaire_recherche_avancee : function() {
		var AppelAjax = new Ajax.Updater(
									...
									contentType:  'application/x-www-form-urlencoded',
									encoding:     'UTF-8',
									parameters: { recherche: '1', nom : escape($F('nom')), id_categorie: $F('id_categorie'), id_profil: $F('id_profil'), page_to_show: $F('page_to_show'), tel: escape($F('tel')), email: escape($F('email')), url: escape($F('url')), code_postal: escape($F('code_postal')), ville: escape($F('ville')), orderby: $F('orderby'), orderorder: $F('orderorder')},
									evalScripts:true, 
									onLoading:S_loading, onException: function (){S_failure();}, 
									onComplete:H_loading}
									);
	...
	annuaire_recherche_collabs : function() {
		var AppelAjax = new Ajax.Updater(
									...
									contentType:  'application/x-www-form-urlencoded',
									encoding:     'UTF-8',
									parameters: { recherche: '1', nom : escape($F('nom_s')), id_profil: $F('id_profil_s'), id_fonction: $F('id_fonction_s'), page_to_show: $F('page_to_show_s'), orderby: $F('orderby_s'), orderorder: $F('orderorder_s')},
									evalScripts:true, 
									onLoading:S_loading, onException: function (){S_failure();}, 
									onComplete:H_loading}
									);
	...
	catalogue_recherche_simple : function() {
		...
		var AppelAjax = new Ajax.Updater(
									...
									contentType:  'application/x-www-form-urlencoded',
									encoding:     'UTF-8',
									parameters: { recherche: '1', ref_art_categ : $F('ref_art_categ_s'), lib_article: escape($F('lib_article_s')), page_to_show: $F('page_to_show_s'), ref_constructeur: $F('ref_constructeur_s'), in_stock: f_stock , is_nouveau: f_nouv , in_promotion: f_promo, orderby: $F('orderby_s'), orderorder: $F('orderorder_s'), id_tarif: $F('id_tarif_s'), id_stock: $F('id_stock_s')},
									evalScripts:true, 
									onLoading:S_loading, onException: function (){S_failure();}, 
									onComplete:H_loading}
									);
	...
	//appel les réponses pour le mini moteur recherche articles
	 catalogue_recherche_mini_simple : function() {		
		...
		var AppelAjax = new Ajax.Updater(
									...
									contentType:  'application/x-www-form-urlencoded',
									encoding:     'UTF-8',
									parameters: { recherche: '1', ref_art_categ : $F('ref_art_categ_s'), lib_article: escape($F('lib_article_s')), page_to_show: $F('page_to_show_s'), ref_constructeur: $F('ref_constructeur_s'),  in_stock: f_stock , is_nouveau: f_nouv , in_promotion: f_promo, id_tarif: "", id_stock: "", orderby: $F('orderby_s'), orderorder: $F('orderorder_s'), fonction_retour: $F('fonction_retour_s'), param_retour: $F('param_retour_s')},
									evalScripts:true, 
									onLoading:S_loading, onException: function (){S_failure();}, 
									onComplete:H_loading}
									);
	...
	utilisateur_recherche_histo : function() {
		var AppelAjax = new Ajax.Updater(
									...
									contentType:  'application/x-www-form-urlencoded',
									encoding:     'UTF-8',
									parameters: { recherche: '1', nom : escape($F('nom_s')), id_profil: $F('id_profil_s'), page_to_show: $F('page_to_show_s'), orderby: $F('orderby_s'), orderorder: $F('orderorder_s') ,ip: $F('ip') , date_debut: $("date_debut").value, date_fin: $("date_fin").value},
									evalScripts:true, 
									onLoading:S_loading, onException: function (){S_failure();}, 
									onComplete:H_loading}
									);
	...
	compte_bancaire_recherche : function() {
		var AppelAjax = new Ajax.Updater(
									...
									contentType:  'application/x-www-form-urlencoded',
									encoding:     'UTF-8',
									parameters: { recherche: '1', id_compte_bancaire: $F('id_compte_bancaire'), page_to_show: $F('page_to_show'), date_fin: $("date_fin").value, date_debut: $("date_debut").value, libelle: escape($("libelle").value), montant: $("montant").value, orderby: $F('orderby'), orderorder: $F('orderorder')},
									evalScripts:true, 
									onLoading:S_loading, onException: function (){S_failure();}, 
									onComplete:H_loading}
									);
	...
	article_livraison_modes_cost_recherche : function() {
		...
		var AppelAjax = new Ajax.Updater(
									...
									contentType:  'application/x-www-form-urlencoded',
									encoding:     'UTF-8',
									parameters: { recherche: '1', ref_art_categ : $F('ref_art_categ_s'), lib_article: escape($F('lib_article_s')), page_to_show: $F('page_to_show_s'), ref_constructeur: $F('ref_constructeur_s'), in_stock: f_stock , is_nouveau: f_nouv , in_promotion: f_promo, orderby: $F('orderby_s'), orderorder: $F('orderorder_s'), id_tarif: $F('id_tarif_s'), id_stock: $F('id_stock_s'), id_livraison_mode: $F("id_livraison_mode")},
									evalScripts:true, 
									onLoading:S_loading, onException: function (){S_failure();}, 
									onComplete:H_loading}
									);
...
function size_file_progress (responseText) {
	...
	if (tableau[1] && tableau[1] != "" ) {$("maj_etat").innerHTML = unescape(tableau[1]);}
	if (tableau[2] && tableau[1] != "" ) {$("info_progress").innerHTML = unescape(tableau[2]);}
	if (tableau[3] && tableau[1] != "" ) {$("info_progress_more").innerHTML = unescape(tableau[3]);}
	}
}
...
function set_maj_or_del_permission_fonction (id_fonction, id_permission, id_profil, add_or_del) {
	var AppelAjax = new Ajax.Request(
									...
									{
									parameters: {id_fonction: id_fonction, id_permission: id_permission, id_profil: id_profil, add_or_del: add_or_del},
									evalScripts:true, 
									onLoading:S_loading, onException: function () {S_failure();},
									onSuccess: function (requester){
															requester.responseText.evalScripts();
...
function maj_permissions_multiple_fonction (id_fonction, id_permission, param_permissions, id_profil) {
	...
	var AppelAjax = new Ajax.Request(
									"fonction_permissions_maj.php", 
									{
									parameters: {id_fonction: id_fonction, id_permission: id_permission, param_permissions: param, id_profil: id_profil},
									evalScripts:true, 
									onLoading:S_loading, onException: function () {S_failure();},
									onSuccess: function (requester){
															requester.responseText.evalScripts();
...
function maj_droits_all_membres_fonction (id_fonction) {
	...
	var AppelAjax = new Ajax.Request(
									...
									{
									parameters: {id_fonction:id_fonction},
									evalScripts:true, 
									onLoading:S_loading, onException: function () {S_failure();},
									onSuccess: function (requester){
															requester.responseText.evalScripts();
...
function agenda_create_AgendaReservationRessource(lib_agenda, ref_ressource, couleur_1, couleur_2, couleur_3){
	var AppelAjax = new Ajax.Request(
		...
		{
			parameters: {type_agenda : "AgendaReservationRessource", lib_agenda: lib_agenda, ref_ressource : ref_ressource, couleur_1 : couleur_1, couleur_2 : couleur_2, couleur_3 : couleur_3},
			evalScripts	:true, 
			onLoading	:S_loading,
...
function agenda_create_AgendaContact(lib_agenda, ref_contact, couleur_1, couleur_2, couleur_3){
	var AppelAjax = new Ajax.Request(
		"agenda_configuration_add.php",
		{
			parameters: {type_agenda : "AgendaContact", lib_agenda: lib_agenda, ref_contact : ref_contact, couleur_1 : couleur_1, couleur_2 : couleur_2, couleur_3 : couleur_3},
			evalScripts	:true, 
			onLoading	:S_loading,
			onException	:function () {S_failure();},
			onSuccess	:function (requester){requester.responseText.evalScripts();},
...
function agenda_create_AgendaLoacationMateriel(lib_agenda, ref_article, couleur_1, couleur_2, couleur_3){
	var AppelAjax = new Ajax.Request(
		"agenda_configuration_add.php",
		{
			parameters: {type_agenda : "AgendaLoacationMateriel", lib_agenda: lib_agenda, ref_article : ref_article, couleur_1 : couleur_1, couleur_2 : couleur_2, couleur_3 : couleur_3},
			evalScripts	:true, 
			onLoading	:S_loading,
			onException	:function () {S_failure();},
			onSuccess	:function (requester){requester.responseText.evalScripts();},
...
function agenda_modif_AgendaReservationRessource(ref_agenda, lib_agenda, ref_ressource, couleur_1, couleur_2, couleur_3){
	var AppelAjax = new Ajax.Request(
		...
		{
			parameters: {ref_agenda : ref_agenda, lib_agenda: lib_agenda, ref_ressource : ref_ressource, couleur_1 : couleur_1, couleur_2 : couleur_2, couleur_3 : couleur_3},
			evalScripts	:true, 
			onLoading	:S_loading,
			onException	:function () {S_failure();},
			onSuccess	:function (requester){requester.responseText.evalScripts();},
...
function agenda_modif_AgendaContact(ref_agenda, lib_agenda, ref_contact, couleur_1, couleur_2, couleur_3){
	var AppelAjax = new Ajax.Request(
		"agenda_configuration_mod.php",
		{
			parameters: {ref_agenda : ref_agenda, lib_agenda: lib_agenda, ref_contact : ref_contact, couleur_1 : couleur_1, couleur_2 : couleur_2, couleur_3 : couleur_3},
			evalScripts	:true, 
			onLoading	:S_loading,
			onException	:function () {S_failure();},
			onSuccess	:function (requester){requester.responseText.evalScripts();},
...
function agenda_modif_AgendaLoacationMateriel(ref_agenda, lib_agenda, ref_article, couleur_1, couleur_2, couleur_3){
	var AppelAjax = new Ajax.Request(
		"agenda_configuration_mod.php",
		{
			parameters: {ref_agenda : ref_agenda, lib_agenda: lib_agenda, ref_article : ref_article, couleur_1 : couleur_1, couleur_2 : couleur_2, couleur_3 : couleur_3},
			evalScripts	:true, 
			onLoading	:S_loading,
			onException	:function () {S_failure();},
			onSuccess	:function (requester){requester.responseText.evalScripts();},
