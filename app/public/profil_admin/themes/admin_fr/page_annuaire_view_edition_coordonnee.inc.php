	...
	<tr>
		...
		<table class="infotable" id="start_visible_<?php echo $caiu?>">
			...
			<tr>
				...
				?>
				<a href="#" id="link_show_coordonnee_lib<?php echo $caiu?>" class="modif_input2"><strong><?php echo  htmlentities($coordonnee->getLib_coord())?></strong></a>
				<script type="text/javascript">
			...
			<tr>
				<td>
				<span class="labelled">Email:</span></td><td><a href="mailto:<?php echo $coordonnee->getEmail();?>"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/mail.gif"  border="0" style="float:right" vspace="5"/></a>
