...
<div>
	<table width="950px" height="350px" border="0" align="right" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF">
		...
		<tr>
			...
			<span class="titre_smenu_page" id="smenu_mail_templates"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_grey.jpg" align="absmiddle" />Gérer les mod&egrave;les d&apos;email</span><br /><br />
			<span class="titre_smenu_page" id="smenu_gerer_newsletters"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_grey.jpg" align="absmiddle" />Gérer les newsletters</span><br /><br />
			<span class="titre_smenu_page" id="smenu_courrier_templates"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_grey.jpg" align="absmiddle" />Gérer les mod&egrave;les de courriers</span><br /><br />
			
			 <br/><br/>
			<span class="titre_smenu_page" id="smenu_gerer_mod_fiche_art"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_grey.jpg" align="absmiddle" />Gérer les mod&egrave;les de fiches articles</span><br /><br />
            <span class="titre_smenu_page" id="smenu_gerer_mod_fiche_contact"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_grey.jpg" align="absmiddle" />Gérer les mod&egrave;les de fiches contacts</span><br /><br />
            <span class="titre_smenu_page" id="smenu_gerer_mod_fiche_stats"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_grey.jpg" align="absmiddle" />Gérer les mod&egrave;les de fiches statistiques</span><br /><br />
            <span class="titre_smenu_page" id="smenu_gerer_mod_etat_stocks"><img src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/puce_grey.jpg" align="absmiddle" />Gérer les mod&egrave;les d'état de stocks</span><br /><br />
