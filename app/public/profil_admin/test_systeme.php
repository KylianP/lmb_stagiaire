	...
	TEST DE VOTRE CONFIGURATION MYSQL<br><br>";
		...
		if (version_compare(mysql_get_client_info(), '5.0') < 0) {
			$retour_texte .= "	Votre version de MySQL est insuffisante. <br>
					Actuellement: ".mysql_get_client_info()." / Recquis: 5.0<br>";
			$GLOBALS['_INFOS']['test_systeme'][] = "Votre version de MySQL est insuffisante. <br>
					Actuellement: ".mysql_get_client_info()." / Recquis: 5.0<br>";
			break;
		}
		$retour_texte .= "MySQL est présent sur le serveur: Actuellement: ".mysql_get_client_info()." / Recquis: 5.0<br>";
