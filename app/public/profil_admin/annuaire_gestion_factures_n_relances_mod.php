...
require ($DIR."_session.inc.php");
	...
	$id_courrier_joint	=	$_REQUEST["id_courrier_joint_".$_REQUEST["id_niveau_relance"]];
	$impression = 0;
...
//ouverture de la class facture_niveaux_relances
	...
	$fact_n_r->maj_relance ($lib_niveau_relance, $delai_before_next, $id_edition_mode, $id_courrier_joint, $impression);
