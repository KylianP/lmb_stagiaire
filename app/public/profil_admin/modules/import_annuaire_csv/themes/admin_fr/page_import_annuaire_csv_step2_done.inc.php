...
if (count($lignes)) { 
	...
	?>
	window.parent.alerte.alerte_erreur ('Import effectué', "<?php echo $GLOBALS['_INFOS']['count_import']."/".$GLOBALS['_INFOS']['total_import']; ?> enregistrements importés<br />",'<input type="submit" id="bouton0" name="bouton0" value="Ok" />');
