...
<?php 
		...
		switch ($_REQUEST["fonction_generer"]) {
			...
			case "import":
				?>
				window.parent.alerte.alerte_erreur ('Import éffectué', "<?php echo $GLOBALS['_INFOS']['count_import']."/".count($liste_rec); ?> enregistrements importés",'<input type="submit" id="bouton0" name="bouton0" value="Ok" />');
				window.parent.page.verify('import_annuaire_csv_step2','modules/import_annuaire_csv/import_annuaire_csv_step2.php','true','sub_content');
				<?php
			break;
