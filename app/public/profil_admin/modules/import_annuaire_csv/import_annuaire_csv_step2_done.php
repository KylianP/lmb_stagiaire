...
$import_annuaire->create($liste_ligne);
//reste t'il des lignes?
$lignes = $dao_csv_import_annu_ligne->readAll();

include ($DIR."profil_".$_SESSION['profils'][$ID_PROFIL]->getCode_profil()."/modules/".$import_annuaire_csv['folder_name']."themes/".$_SESSION['theme']->getCode_theme()."/page_import_annuaire_csv_step2_done.inc.php");
