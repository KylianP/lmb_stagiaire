...
maj_configuration_file ("config_generale.inc.php", "maj_line", "\$PIED_DE_PAGE_GAUCHE_0 =", "\$PIED_DE_PAGE_GAUCHE_0 = \"".str_replace("¤", "€", ($_REQUEST["pied_de_page_gauche_0"]))."\";", $CONFIG_DIR);

maj_configuration_file ("config_generale.inc.php", "maj_line", "\$PIED_DE_PAGE_GAUCHE_1 =", "\$PIED_DE_PAGE_GAUCHE_1 = \"".str_replace("¤", "€", ($_REQUEST["pied_de_page_gauche_1"]))."\";", $CONFIG_DIR);

maj_configuration_file ("config_generale.inc.php", "maj_line", "\$PIED_DE_PAGE_DROIT_0 =", "\$PIED_DE_PAGE_DROIT_0 = \"".str_replace("¤", "€", ($_REQUEST["pied_de_page_droit_0"]))."\";", $CONFIG_DIR);

maj_configuration_file ("config_generale.inc.php", "maj_line", "\$PIED_DE_PAGE_DROIT_1 =", "\$PIED_DE_PAGE_DROIT_1 = \"".str_replace("¤", "€", ($_REQUEST["pied_de_page_droit_1"]))."\";", $CONFIG_DIR);
