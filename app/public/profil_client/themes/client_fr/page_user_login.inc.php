	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" style="background-color:#FFFFFF">
			...
			<tr>
				...
				<a href="http://www.lundimatin.fr" target="_blank" class="grey_text">Lundi Matin Business</a> est un logiciel libre de gestion d'entreprise, distribué sous licence <a href="http://www.lundimatin.fr/site/licence_opensource_lmpl.php" target="_blank" class="grey_text">LMPL</a>
				</div>
				</td>
				</tr>
				</table>
