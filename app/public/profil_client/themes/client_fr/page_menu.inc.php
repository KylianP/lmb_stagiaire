...
if ($_SESSION['user']->getLogin()) {
	?>
	, <?php echo str_replace (CHR(13), " " ,str_replace (CHR(10), " " , $_SESSION['user']->getContactName ()));?>
	<?php 
}
?>
</div>
...
<a href='catalogue_panier_view.php'>Mon Panier</a> 
	...
	<script type="text/javascript">
		Event.observe('aff_panier', 'mouseover',  function(evt){Event.stop(evt);
			$("panier").toggle();
		}, false);
		Event.observe('aff_panier', 'mouseout',  function(evt){Event.stop(evt);
			$("panier").toggle();
		}, false);
	</script>
</li>
...
if ($_SESSION['user']->getLogin()) {
	...
	<script type="text/javascript">
		Event.observe('sedeconnecter', 'click',  function(evt){Event.stop(evt);
	...
	<script type="text/javascript">
		Event.observe('seconnecter', 'click',  function(evt){Event.stop(evt);
