		...
		<div style="width:500px;	margin:0px auto;">
			...
			<table border="0" cellspacing="0" cellpadding="0" style="background-color:#FFFFFF">
				...
				<tr>
					...
					<div class="title_content" style="text-align:right">INSCRIPTION <img  src="<?php echo $DIR.$_SESSION['theme']->getDir_theme()?>images/icone_contact.gif" style="vertical-align:text-bottom"/> </div>
					<br />
					<br />
