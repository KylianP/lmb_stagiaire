	...
	<tr>
		...
		<br /><br />
							...
							<div class="infos_coord">
								...
								<br />
								<?php 
									// Controle du numéro de téléphone de l'entreprise
									if ($coordonnees_entreprise[0]->getTel1()) {
										echo " Tél : ", $coordonnees_entreprise[0]->getTel1();		
									} 
								?> <br />
								<?php 
									// Controle du numéro de fax de l'entreprise
												...
												<FORM method="post" action="" onSubmit="return test(this.Nom,this.Email)">
													...
													<table width="100%" border="0" cellspacing="3" cellpadding="0" style="font-size:20px;">
														<tr>
															...
															<?php
															// On recherche la première adresse mail dans l'adresse du contact
															$i = 0;
														...
														<tr>
															<td class="lib_contact"><div class="lib_contact">Téléphone:</div></td>
