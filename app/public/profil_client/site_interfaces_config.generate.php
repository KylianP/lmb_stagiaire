...
if (!count($GLOBALS['_ALERTES'])) {
  ...
  $string_file = preg_replace('/\$SUJET_INSCRIPTION_VALIDATION_FINAL = ".*?";/s', '\$SUJET_INSCRIPTION_VALIDATION_FINAL = "'.addslashes($_REQUEST['sujet_inscription_validation_final']).'";', $string_file);
  $string_file = preg_replace('/\$CONTENU_INSCRIPTION_VALIDATION_FINAL = ".*?";/sm', '\$CONTENU_INSCRIPTION_VALIDATION_FINAL = "'.addslashes($_REQUEST['contenu_inscription_validation_final']).'";', $string_file);
