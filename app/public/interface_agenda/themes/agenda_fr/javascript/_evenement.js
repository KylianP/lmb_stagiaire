...
//###########################################################################
//###########################################################################
function new_Evenement(grille, zero, node, gestionnaireEvenement, id_type_agenda, ref_agenda, id_type_event, ref_event){
	var tmp = null;
	switch (scale_used) {
	case "jour":{
		tmp  = new EvenementJour(grille, zero, node, gestionnaireEvenement, id_type_agenda, ref_agenda, id_type_event, ref_event);
		tmp.initializeObject();
		break;}
	case "semaine":{
		tmp  = new EvenementSemaine(grille, zero, node, gestionnaireEvenement, id_type_agenda, ref_agenda, id_type_event, ref_event);
		tmp.initializeObject();
		break;}
	case "mois":{break;}
	}
...
Evenement.prototype = {
	initialize: function(grille, zero, node, gestionnaireEvenement, id_type_agenda, ref_agenda, id_type_event, ref_event){
