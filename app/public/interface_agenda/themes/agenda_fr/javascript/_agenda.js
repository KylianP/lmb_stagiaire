...
function CreateDivEvenement(id, top, left, width, height, cssClassName){
	...
	var html_content = '<div id="event_CONETNU_'+id+'" style="height:100%;" >'+
							'<div id="event_moveG'+id+'" class="event_div_titre_G" style="background-color:#7f2d22;">'+//#7f2d22 = COULEUR 1
							'</div>'+
...
function showOnPanel(echelle, id_graphic_event, ref_event, Udate_event, duree_event) {
...
function majSelect_Options_events_types(ref_agenda, target, droitsCibles){
	sDroitsCibles = "";
	...
	var AppelAjax = new Ajax.Updater(
		...
		"agenda_maj_select_options_events_types.php", {
			...
			contentType		:'application/x-www-form-urlencoded',
			encoding		:'UTF-8',
			parameters		:{ ref_agenda: ref_agenda, droitsCibles : sDroitsCibles},
			evalScripts		:false,
			asynchronous	:false,
