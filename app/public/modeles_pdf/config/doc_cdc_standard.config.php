...
$DOC_STANDARD['TEXTE_CORPS_PIEDS']="Le client déclare commander dans le magasin de manière ferme et définitive les articles indiqués ci-dessus et reconnait avoir pris connaissance des CGV régulièrement affichées en magasin et disponible sur le site internet, dont j'accepte les termes sans exception ni réserve.";//TXTA()// Texte entre corps et pied de page// texte sur trois lignes
