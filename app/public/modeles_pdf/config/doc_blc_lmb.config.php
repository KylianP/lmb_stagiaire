...
$DOC_STANDARD['TEXTE_CORPS_PIEDS'][0]="Le client reconnait avoir procédé à la vérification d'usage des marchandises ou développements logiciels livrés.";//TXTE()// Texte entre corps et pied de page//ligne n°1
$DOC_STANDARD['TEXTE_CORPS_PIEDS'][1]="A défaut de mention sur le bon de livraison, aucune réclamation ne sera admise après réception de la marchandise ou des développements logiciels, sauf en cas de vice caché.";//TXTE()// Texte entre corps et pied de page//ligne n°2
$DOC_STANDARD['TEXTE_CORPS_PIEDS'][2]="Réserve de propriété applicable selon la loi n°80.335 du 12 mai 1980. Les droits de propriété intellectuelle seront cédés après paiement intégral des prestations.";//TXTE()// Texte entre corps et pied de page//ligne n°3
