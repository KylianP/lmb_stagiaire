...
$DOC_STANDARD['TEXTE_CORPS_PIEDS'][0]="Montants exprimés en Euros. Aucun escompte ne sera accordé pour paiement anticipé. Tout retard de règlement donnera lieu de plein droit et sans qu'aucune mise en demeure ne soit";//TXTE()// Texte entre corps et pied de page//ligne n°1
$DOC_STANDARD['TEXTE_CORPS_PIEDS'][1]="nécessaire au paiement de pénalités de retard sur la base du taux BCE majoré de dix (10) points et au paiement d'une indemnité forfaitaire pour frais de recouvrement d'un montant de 40€.";//TXTE()// Texte entre corps et pied de page//ligne n°2
